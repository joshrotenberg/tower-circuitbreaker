...
async fn main() {
    ...
    let breaker_layer = cirucuit_breaker_builder::<String, ()>()
    ...
    // Create a service with our flaky function and the circuit breaker layer
    // let mut svc = ServiceBuilder::new().layer(breaker_layer).service(flaky);
